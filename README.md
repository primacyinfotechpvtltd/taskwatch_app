...
### For macOS Users
Send them: `PI_Task_Watch_macOS_v1.0.35.dmg`

### For Windows Users
Send them: `PI_Task_Watch_Windows_v1.0.35.zip` or the Installer executable

### For Linux Users
Send them: `pi-task-watch_1.0.35_amd64.deb` or `PI_Task_Watch_Linux_v1.0.35.zip`
